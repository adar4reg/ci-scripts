...
class Synchronizer
  ...
  LOCK_PATH = "/tmp/GmsCoredrivesync.lock"
  MANIFEST_PATH = File.expand_path "~/.drivesync/GmsCoremanifest"
  MANIFEST_PATH_OLD = File.expand_path "~/.drivesync_GmsCoremanifest"
