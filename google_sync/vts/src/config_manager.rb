class ConfigManager
  ...
  CONFIG_PATH = File.expand_path('~/.drivesync/vtsconfig.yml')
  CONFIG_PATH_OLD = File.expand_path("..", File.dirname(__FILE__)) + "/vtsconfig.yml"
  DEFAULT_CONFIG_PATH = File.dirname(__FILE__) + '/vtsdefaultconfig'
  CONFIG_VERSION = 1.2
