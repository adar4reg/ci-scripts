class ConfigManager
  ...
  CONFIG_PATH = File.expand_path('~/.drivesync/GmsCoreconfig.yml')
  CONFIG_PATH_OLD = File.expand_path("..", File.dirname(__FILE__)) + "/GmsCoreconfig.yml"
  DEFAULT_CONFIG_PATH = File.dirname(__FILE__) + '/GmsCoredefaultconfig'
  CONFIG_VERSION = 1.2
