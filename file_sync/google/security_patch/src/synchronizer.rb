...
class Synchronizer
  ...
  LOCK_PATH = "/tmp/securitydrivesync.lock"
  MANIFEST_PATH = File.expand_path "~/.drivesync/securitymanifest"
  MANIFEST_PATH_OLD = File.expand_path "~/.drivesync_securitymanifest"
