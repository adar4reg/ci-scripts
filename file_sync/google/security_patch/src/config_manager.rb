class ConfigManager
  ...
  CONFIG_PATH = File.expand_path('~/.drivesync/securityconfig.yml')
  CONFIG_PATH_OLD = File.expand_path("..", File.dirname(__FILE__)) + "/securityconfig.yml"
  DEFAULT_CONFIG_PATH = File.dirname(__FILE__) + '/securitydefaultconfig'
  CONFIG_VERSION = 1.2
