...
#
# use https://github.com/MStadlmeier/drivesync
# copy vtsconfig.yml to ~/.drivesync/vtsconfig.yml
...
def config
  system("\"${EDITOR:-vi}\" #{File.expand_path('~/.drivesync/vtsconfig.yml')}")
end
=begin
...
while (true) do
  ...
  puts datetime + " .. sleep 43200 seconds .."
  puts ""
  sleep 43200
end
###
